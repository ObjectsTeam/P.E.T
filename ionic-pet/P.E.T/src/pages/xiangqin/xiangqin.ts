...
export class XiangqinPage {
  items=['公','母'];
  province = ["北京市","上海市","天津市","重庆市","河北省","山西省","辽宁省","吉林省","河南省","江苏省","浙江省","安徽省","福建省","江西省","山东省","湖北省","湖南省","广东省","海南省","四川省","贵州省","云南省","陕西省","甘肃省","青海省","黑龙江省","内蒙古自治区","广西壮族自治区","西藏自治区","宁夏回族自治区","新疆维吾尔自治区","台湾省","香港特别行政区","澳门特别行政区","其它"]
 ...
 city=[]
 vips=['1-5岁','6-10岁','11-15岁']
 
  constructor(public navCtrl: NavController, public navParams: NavParams) {
  }

  ionViewDidLoad() {
    console.log('ionViewDidLoad XiangqinPage');
  }
  icon='arrowd';
  icon2='arrowd';
  icon3='arrowd';
  ...
  fuwu(){
    if(this.L==false){
    $('.serve').css('color','#ffcc00')
    $('.fuwu').css('color','#ffcc00')
  ...
  diqu(){
    if(this.G==false){
    $('.city').css('color','#ffcc00')
    $('.diqu').css('color','#ffcc00')
    $('.serve').css('color','black')
      $('.fuwu').css('color','black')
      $('.leavl').css('color','black');
      $('.dengji').css('color','black');
  ...
  dengji(){
    if(this.H==false){
    $('.leavl').css('color','#ffcc00');
    $('.dengji').css('color','#ffcc00');
    $('.serve').css('color','black')
    $('.fuwu').css('color','black')
  ...
  Yes(e){
    $(e.currentTarget).css('color','#ffcc00');
